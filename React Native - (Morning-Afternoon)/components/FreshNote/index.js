...
const NewNoteCard = ({ navigation }) => {
    ...
    return (
        ...
        <Text style = {{fontSize: 20}}>Title</Text>
            <TextInput multiline style={styles.input} placeholder="Enter note Title" onChangeText={setTitle} />
        <Text></Text>
           
           <Text style = {{fontSize: 20}}>Description</Text>
            <TextInput multiline style={styles.input} placeholder="Enter note " onChangeText={setDescription} />
        <Text></Text>
        <Text></Text>
