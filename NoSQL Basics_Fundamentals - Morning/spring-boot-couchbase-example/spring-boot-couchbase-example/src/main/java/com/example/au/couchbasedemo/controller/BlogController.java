...
//    List<Blogs> a = new ArrayList<Blogs>();
    ...
    public ArrayList<Blogs> getBlogByTagName(@PathVariable String tags) {
//        return blogRepository.findByTags(tags);
    	ArrayList <Blogs> answer = new ArrayList<Blogs>();
    	
    	answer.addAll(blogRepository.findByTag1(tags));
    	answer.addAll(blogRepository.findByTag2(tags));
    	answer.addAll(blogRepository.findByTag3(tags));
