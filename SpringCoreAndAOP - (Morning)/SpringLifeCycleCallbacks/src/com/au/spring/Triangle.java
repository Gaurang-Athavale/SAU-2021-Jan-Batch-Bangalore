...
//   
	...
	public void draw() {
		System.out.println("PointAx:"+getPointA().getX()+"\tPointAy:"+getPointA().getY());
		System.out.println("PointBx:"+getPointB().getX()+"\tPointBy:"+getPointB().getY());
		System.out.println("PointCx:"+getPointC().getX()+"\tPointCy:"+getPointC().getY());
	}
